...
function handleFormat(config, textDocument, text, next) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var command, _a, rootPatterns, isStdout, isStderr, _b, args, ignoreExitCode, workDir, cmd, _c, _d, stdout, _e, stderr, code, output;
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    command = config.command, _a = config.rootPatterns, rootPatterns = _a === void 0 ? [] : _a, isStdout = config.isStdout, isStderr = config.isStderr, _b = config.args, args = _b === void 0 ? [] : _b, ignoreExitCode = config.ignoreExitCode;
